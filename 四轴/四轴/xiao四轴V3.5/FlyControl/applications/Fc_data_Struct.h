...
typedef struct PostionCtrl
{
    ...
    PidStruct PostionSpeedCtrlX;
    PidStruct PostionSpeedCtrlY;
    s16     HomeX;
    s16     HomeY;
    ...
    s16     Postionx_i;
    s16     Postiony_i;
    s16     Postionx_i_filter;
    s16     Postiony_i_filter;
    s16     Postionx_i_angle;
    s16     Postiony_i_angle;
    s16     Postionx_out;
    s16     Postiony_out;
    s16     Postionx_out_old;
    s16     Postiony_out_old;

    float     Postionx_speed;
    float     Postiony_speed;
    float     Postionx_speed_out;
    float     Postiony_speed_out;
