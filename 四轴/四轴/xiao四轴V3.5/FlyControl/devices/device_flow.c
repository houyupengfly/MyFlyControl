...
void ReadMotion(void)
{
    ...
    g_FlyControlDataStruct.AppPostionCtrl.Postionx=MotionData.d[2]|MotionData.d[3]<<8;
    g_FlyControlDataStruct.AppPostionCtrl.Postiony=MotionData.d[4]|MotionData.d[5]<<8;
    SPI2_CSN_H();
