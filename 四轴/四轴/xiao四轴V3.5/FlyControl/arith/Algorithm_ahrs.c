...
{		
	...
	g_FlyControlDataStruct.AppImuDataStruct.Nx = g_FlyControlDataStruct.App_AngleStruct.x_vec.x *g_FlyControlDataStruct.App_AngleStruct.a_acc.x + g_FlyControlDataStruct.App_AngleStruct.x_vec.y *g_FlyControlDataStruct.App_AngleStruct.a_acc.y +  g_FlyControlDataStruct.App_AngleStruct.x_vec.z *g_FlyControlDataStruct.App_AngleStruct.a_acc.z;
    g_FlyControlDataStruct.AppImuDataStruct.Ny = g_FlyControlDataStruct.App_AngleStruct.y_vec.x *g_FlyControlDataStruct.App_AngleStruct.a_acc.x + g_FlyControlDataStruct.App_AngleStruct.y_vec.y *g_FlyControlDataStruct.App_AngleStruct.a_acc.y +  g_FlyControlDataStruct.App_AngleStruct.y_vec.z *g_FlyControlDataStruct.App_AngleStruct.a_acc.z;
